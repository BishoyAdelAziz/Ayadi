         ...
         */ !(function (r, a) {
          ...
          (n = function () {
                    ...
                    (function (i) {
                      ...
                      (t.style.transition = t.style.webkitTransition =
                        "fadeIn" === l.animation
                          ...
                          : "none"),
                        "auto" === l.buttons &&
                          (("ontouchstart" in window) || 1 === p.length) &&
                          (l.buttons = !1),
                        (s.style.display = n.style.display =
                          l.buttons ? "" : "none");
                      try {
                    ...
                    o = (function (e) {
                      ...
                      if (e.dataset) {
                        ...
                        for (var n in e.dataset)
                          "at-" !== n.substring(0, 3) ||
                            isNaN(n.substring(3)) ||
                            (s[n.replace("at-", "")] = e.dataset[n]);
                        for (
                          var i = Object.keys(s).sort(function (e, t) {
            ...
            return (
              ...
              [].filter ||
                (Array.prototype.filter = function (e, t, s, n, i) {
                  for (s = this, n = [], i = 0; i < s.length; i++)
                  ...
                  return (
                    ...
                    (function () {
                      ...
                      (e = W("div")).setAttribute("role", "dialog"),
                        ...
                        e.appendChild(t),
                        (s = W("button")).setAttribute("type", "button"),
                        (s.id = "previous-button"),
                        s.setAttribute("aria-label", "Previous"),
                        (s.innerHTML = c.svg ? r : "&lt;"),
                        e.appendChild(s),
                        (n = W("button")).setAttribute("type", "button"),
                        (n.id = "next-button"),
                        n.setAttribute("aria-label", "Next"),
                        (n.innerHTML = c.svg ? a : "&gt;"),
                        e.appendChild(n),
                        (i = W("button")).setAttribute("type", "button"),
                        (i.id = "close-button"),
                        i.setAttribute("aria-label", "Close"),
                        (i.innerHTML = c.svg ? o : "&times;"),
                        e.appendChild(i),
                        (s.className =
                          n.className =
                          i.className =
                            "baguetteBox-button"),
                        (function () {
                          var r = c.passiveEvents ? { passive: !1 } : null,
                          ...
                          V(e, "click", y),
                            ...
                            V(e, "touchmove", x, r),
                            V(e, "touchend", k),
                            V(document, "focus", M, !0);
                        })();
                    })(),
                    O(l),
                    (function (e, t) {
                      var s = document.querySelectorAll(e),
                        n = { galleries: [], nodeList: s };
                      return (
                        (v[e] = n),
                        [].forEach.call(s, function (e) {
                          ...
                          if (
                            ...
                            0 !==
                              (s = [].filter.call(s, function (e) {
                                if (
                                  -1 === e.className.indexOf(t && t.ignoreClass)
                                )
                            ...
                            [].forEach.call(s, function (e, s) {
                              var n = function (e) {
                                ...
                                r = { eventHandler: n, imageElement: e };
            ...
            void 0 === (i = "function" == typeof n ? n.call(t, s, t, e) : n) ||
              (e.exports = i);
        })();
      },
    },
  ...
  (s.n = (e) => {
    ...
    (() => {
            ...
            for (let t = 0, i = s.length; t < i; t += 1) {
              ...
              void 0 !== r &&
                ...
                (w(e[i]) && w(n[i])
                  ...
                  : !w(e[i]) && w(n[i])
                  ? ((e[i] = {}),
                    n[i].__swiper__ ? (e[i] = n[i]) : C(e[i], n[i]))
                  : (e[i] = n[i]));
            }
          }
        }
      ...
      function E(e) {
        ...
        const c = s > r ? "next" : "prev",
          ...
          u = () => {
            ...
            let c = r + o * (s - r);
            if ((p(c, s) && (c = s), t.wrapperEl.scrollTo({ [n]: c }), p(c, s)))
              return (
      ...
      const L = {
        ...
        updateSlides: function () {
          ...
          for (let i = 0; i < p; i += 1) {
            ...
            const a = c.eq(i);
            if (
              (S && e.grid.updateSlide(i, a, p, t), "none" !== a.css("display"))
            ) {
      ...
      const B = {
        loopCreate: function () {
          ...
          for (let e = 0; e < l.length; e += 1)
            i.append(m(l[e].cloneNode(!0)).addClass(s.slideDuplicateClass));
          for (let e = o.length - 1; e >= 0; e -= 1)
            i.prepend(m(o[e].cloneNode(!0)).addClass(s.slideDuplicateClass));
        },
        loopFix: function () {
          const e = this;
      ...
      function N(e) {
        ...
        if (!s.allowTouchMove)
          return (
            m(d.target).is(n.focusableElements) || (s.allowClick = !1),
            void (
              n.isTouched &&
              (Object.assign(a, {
                startX: p,
            ...
            ? ((b = !1),
              i.resistance &&
                (n.currentTranslate =
                  s.minTranslate() -
                  1 +
                  (-s.minTranslate() + n.startTranslate + g) ** w))
            : g < 0 &&
              ...
              i.resistance &&
                (n.currentTranslate =
                  s.maxTranslate() +
                  1 -
                  (s.maxTranslate() - n.startTranslate - g) ** w)),
          ...
          "next" === t.swipeDirection &&
            ...
            "prev" === t.swipeDirection &&
              (b > 1 - n.longSwipesRatio
                ? t.slideTo(u + w)
                : null !== m && b < 0 && Math.abs(b) > n.longSwipesRatio
                ? t.slideTo(m)
                : t.slideTo(u));
        } else {
      ...
      const R = {
          attachEvents: function () {
            ...
            (e.onTouchStart = D.bind(e)),
              ...
              (e.onClick = _.bind(e)),
              n.touch && !H && (t.addEventListener("touchstart", V), (H = !0)),
              q(e, "on");
          },
        ...
        function (e) {
          ...
          function p() {
            ...
            if ("bullets" === e.type) {
              ...
              n.html(r), (t.pagination.bullets = n.find(se(e.bulletClass)));
            }
            "fraction" === e.type &&
              ((r = e.renderFraction
        ...
        function (e) {
          ...
          function l() {
            return (
              void 0 === t &&
              !s.autoplay.running &&
              ((s.autoplay.running = !0), a("autoplayStart"), o(), !0)
            );
          }
          function d() {
            return (
          ...
          function h() {
            s.params.autoplay.disableOnInteraction ||
              ((s.autoplay.paused = !1), a("autoplayResume"), o());
          }
